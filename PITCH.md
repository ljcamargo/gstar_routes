...
2. **AI Reasoning**: Validate that Gemini can effectively solve graph search problems when provided with context-rich subsets of data.
3. **User Experience**: Provide a "wow" factor with a premium, high-tech interface that feels as advanced as the underlying tech.
